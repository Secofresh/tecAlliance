...
public abstract class BaseArticle {
    ...
    @Schema(description = "Unique identifier of the article", example = "507f1f77bcf86cd799439011", accessMode = Schema.AccessMode.READ_ONLY)
    protected String id;
    ...
    protected BaseArticle(String id, String name, String slogan,
